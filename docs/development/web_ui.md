...
- visual system/layout: `docs/ui_design/ui_design.md`,
- React architecture/state: `docs/ui_design/ui_react_design.md`,
- header: `docs/ui_design/ui_header_spec.md`,
- editor/runtimes/nodes/edges/logs: `docs/ui_design/ui_editor_panel_spec.md`,
- media graph: `docs/ui_design/ui_media_graph_spec.md`,
- viewer: `docs/ui_design/ui_viewer_panel_spec.md`,
- parameters/media inspection: `docs/ui_design/ui_parameter_panel_spec.md`.
...
The complete endpoint contract is maintained in `docs/release/rest_api.md`.
...
Files below `docs/development/api/` are generated by Doxygen and are not edited as UI design
